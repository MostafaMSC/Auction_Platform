        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedBudgetAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VerificationDocs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VerificationDocs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartingPriceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CurrentPriceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MinPriceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TargetPriceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    StartAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MaxDuration = table.Column<TimeSpan>(type: "time", nullable: false),
                    PriceDropInterval = table.Column<TimeSpan>(type: "time", nullable: false),
                    PriceDropAmountValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    WinningBidId = table.Column<int>(type: "int", nullable: true),
                    WinningBidId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auctions_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_ProjectId",
                table: "Auctions",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Auctions_StartAt_EndAt",
                table: "Auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_WinningBidId1",
                table: "Auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationDocs_UserId",
                table: "VerificationDocs",
                column: "UserId");

            migrationBuilder.AddForeignKey(
                name: "FK_Auctions_Bids_WinningBidId1",
                table: "Auctions",
                column: "WinningBidId1",
                principalTable: "Bids",
                principalColumn: "Id");
